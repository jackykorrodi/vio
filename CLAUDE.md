...
6. `public/vio-regelkatalog-politik-v3-6.md` (SPEC_VERSION 3.7) - only for Politik price/reach/budget/bookability logic

Never read legacy files unless explicitly needed:

- `public/vio-regelkatalog-paketlogik.md`
- Aktiver Regelkatalog: ausschliesslich `public/vio-regelkatalog-politik-v3-6.md` (SPEC_VERSION 3.7). Alle anderen `public/vio-regelkatalog-politik-*.md` sind deprecated und dürfen NICHT gelesen werden.
...
2. `public/vio-regelkatalog-politik-v3-6.md` (SPEC_VERSION 3.7)

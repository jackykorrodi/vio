      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        <div id="hero-grid" style={{
          ...
          <div style={{
            ...
            <div style={{ position: 'absolute', left: '50%', top: 0, transform: 'translateX(-50%)', zIndex: 1, pointerEvents: 'none' }}>
              <SwissAquarelle />
            </div>
